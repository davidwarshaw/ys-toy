...
export default class BumpAttackSystem {
  ...
  resolveAttack(attacker, attackerFacing, defender, defenderFacing) {
    if (attacker.name === "player" && defender.name === "enemy") {
    ...
    } else if (attacker.name === "enemy" && defender.name === "player") {
    ...
    if (relativeDirection === "front" && attacker.name === "enemy" && defender.name === "player") {
  ...
  resolveCombat(first, second) {
    ...
    if (firstFacing === firstDirectionToSecond) {
      ...
      if (first.name != "player" || (first.name === "player" && first.buttonPressed)) {
